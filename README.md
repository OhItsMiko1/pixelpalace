...
(`gen_characters.py`, `gen_tiles.py`, `gen_buildings.py`) — pixel-level
generators, not AI-generated images, built around a shared body
template + per-class palette/silhouette. Regenerate after tweaking them:
