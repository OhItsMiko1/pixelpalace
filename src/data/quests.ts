...
export const QUEST_SPECS: Quest[] = [
  ...
  },
  {
    ...
    summary: "Kessa made it back from the Sewers with a scorched, unreadable scrap of parchment. She's got stories, and a favor to ask.",
    steps: [
      { type: 'talk', targetId: 'kessa', text: 'Check on Kessa, fresh back from the Sewers.' },
      { type: 'talk', targetId: 'mira', text: 'Ask Mira if she can make sense of the scrap Kessa found.' },
      { type: 'talk', targetId: 'kessa', text: "Bring Mira's answer back to Kessa." },
    ],
